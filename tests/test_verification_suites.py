...
def _dummy_summary() -> MetricSummary:
    return MetricSummary(
        ...
        externally_verified_target_satisfaction_rate=None,
        infeasible_handling_accuracy=None,
        end_to_end_scenario_pass_rate=0.0,
        external_lof_verification_accuracy=None,
        repeatability_rate=None,
        average_latency_ms=10.0,
        p95_latency_ms=10.0,
        constraint_gate_compliance_rate=None,
        total_scenarios=1,
        total_runs=1,
        total_candidates=0,
    )
